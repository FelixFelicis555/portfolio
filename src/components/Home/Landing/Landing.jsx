        ...
        <div className="bg-blue landing-container">
            <div className="landing-block-left">
                <div className="content">
                    <p className="text-white ls-3 p-1 fw-400">Hi, I'm <br />Pavanesh</p>
                </div>

            </div>
            <div className="landing-block-right text-white">
                <div className="content">
                    <p className="mb-4">A Full Stack developer & ML Engineer  having 1+ years of experience in developing enterprise-level web apps.</p>
